<template>
  <div :style="{backgroundColor: '#3C4043'}" >
    ...
    <b-container style="color: #ffffff;"> 
        ...
        <b-row>
         <b-col class="mb-5" sm="12" md="6" xl="3"  style="text-align:center;" v-for="(item, index) in serviciosComputados" v-bind:key="item.name">
...
export default {  
  ...
  computed: {
    serviciosComputados: function () {
      return this.servicios.filter((e) => e.enabled); 
    }
  },
  methods: {
    select(id) {
