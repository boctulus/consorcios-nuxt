    ...
    <v-layout row justify="center">
      <v-dialog v-model="dialog" persistent   max-width="800px" :style="{ position: 'absolute', elevation: 100, zIndex:6000 }">
        ...
        <v-card>
          ...
          <v-card-text>
            <v-text-field v-model="editedItem.question" :class="{'disable-events': formMode=='see'}" label="Pregunta"></v-text-field>
    ...
    ">
        ...
        >
            <template  v-slot:items="props">
                ...
                <td>{{ props.item.answer | firstWords(4) }}</td>
...
<script>
  // http://www.vue-tags-input.com/#/examples/nuxt
